...
- [x] 4. Build forum system
- [x] 4.1 Implement subforum data layer
...
- [x] 4.3 Create subforum UI components
...
- [x] 4.7 Create post UI components
...
- [x] 4.10 Implement comment system
