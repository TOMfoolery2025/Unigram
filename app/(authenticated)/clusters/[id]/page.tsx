...
function ChannelPageContent() {
      ...
      <>
        ...
        <main className='min-h-screen bg-background/80 flex items-center justify-center px-4'>
          <Card className='max-w-xl w-full border-border/60 bg-card/90'>
            ...
            <CardContent className='pb-6 md:pb-8 pt-0 text-center space-y-4 px-4 md:px-6'>
              <p className='text-xs md:text-sm text-muted-foreground'>
                {error ||
  ...
  return (
    <>
      ...
      <main className='flex h-[calc(100vh-4rem)] md:max-h-[760px] w-full max-w-[1100px] flex-col bg-card shadow-xl overflow-hidden'>
        <ChannelView
          channel={channel}
